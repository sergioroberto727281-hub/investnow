  ...
  head: () => ({
    meta: [
      ...
      { title: "InvestWise — Grow Your Wealth With Smart Investments" },
      {
        name: "description",
        content:
          "InvestWise is a premium investment platform with institutional-grade portfolios, transparent returns, and 24/7 wealth management for everyone.",
      },
      { name: "author", content: "InvestWise" },
      { property: "og:title", content: "InvestWise — Smart Investments" },
      {
        property: "og:description",
        content:
          "Premium wealth management with institutional-grade portfolios and transparent returns.",
      },
